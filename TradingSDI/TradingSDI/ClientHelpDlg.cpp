...
BOOL ClientHelpDlg::OnInitDialog()
{
	...
	client_grid.SetColWidth(3,80);
	client_grid.SetColWidth(4,90);
	client_grid.SetColWidth(5,90);
	client_grid.SetColWidth(6,90);
	client_grid.SetColWidth(7,90);
	client_grid.SetColWidth(8,90);
