...
void overview::get_client_details()
{
	...
	hr=artists1.Open(session_update,strCommand_char);	
	if(SUCCEEDED(hr))
	{
...
void overview::OnBnClickedButton2()
{
	...
	CoInitialize(NULL);
	 ...
	 _bstr_t r_time="";
	 _bstr_t bstrConnect ="Provider=SQLOLEDB.1;SERVER=68.168.101.187;Database=CheckData;uid=sa;pwd=ok@12345;";		
...
void overview::OnIdclose()
{
	...
	OverViewOrderGrid::thred_kill=1;
	//while(OverViewOrderGrid::OverViewOrderGrid_terminate==0)
	//{}
...
void overview::OnBnClickedButton3()
{
	...
	_bstr_t valField1("");
		...
		_bstr_t strCnn("Provider=SQLOLEDB;SERVER=68.168.101.187;Database=CheckData;uid=sa;pwd=ok@12345;");
